...
public class MessageSeparatorTest {
    ...
    String second_part = "(cont) ラットフォームについて解説する。クラスライブラリなどを含めた、Javaバイトコードの実行環境と開発環境（広義のJava）については、Javaプラットフォームを参照。また、言語の文法に関してはJavaの文法を参照。";
    ...
    public void test() {
            ...
            while (sep.hasNext()) {
                ...
                assertTrue((msg.length() == 140 && first_part.equals(msg)) 
                        || msg.length() == 113 && second_part.equals(msg));
                System.out.println("--------------------");
